...
const MaterialIcons = require('react-native-vector-icons/MaterialIcons').default as React.ElementType;
const Octicons = require('react-native-vector-icons/Octicons').default as React.ElementType;
